...
public class Ctrl_F extends javax.swing.JFrame {
    ...
    private static Ctrl_F singleton;
    
    public static Ctrl_F getInstance() throws BadLocationException {
        if (singleton == null) {
            singleton = new Ctrl_F(arquivo,busca);
        }
        return singleton;
    }
    ...
    private void inicializaTexto () {
        String textoArquivo = COO.Fachada.inicializarTexto(arquivo);
