#ifndef CMDSHOW_ELEMENTS_SHRINK_HPP_
#define CMDSHOW_ELEMENTS_SHRINK_HPP_

#include "CommandShowOf.hpp"

template<typename _TPrint>
class CmdShowOfElementsShrink : public CommandShowOf<_TPrint>{
public:
...
public:
   ...
   CmdShowOfElementsShrink(TPrint *print_i, int nModes_i=1, int mode_i=0)
      :TCommand(print_i, nModes_i, mode_i), meshHandler_(print_i->meshHandler_){
         
      this->helpMessage_ = "shrink all elements (edge, face, and cells)";
      this->step_ = 0.1;
   }
