#ifndef CMDSHOW_CELL_INCREASE_HPP_
#define CMDSHOW_CELL_INCREASE_HPP_

#include "CommandShowOf.hpp"

template<typename _TPrint>
class CmdShowOfCellIncrease : public CommandShowOf<_TPrint>{
public:
...
public:
   ...
   CmdShowOfCellIncrease(TPrint *print_i, int nModes_i=1, int mode_i=0)
