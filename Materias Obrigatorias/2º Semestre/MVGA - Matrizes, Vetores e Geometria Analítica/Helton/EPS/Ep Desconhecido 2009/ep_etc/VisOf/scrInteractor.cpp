...
//[EP] ----VARIÁVEIS QUE ARMAZENAM AS COORDENADAS DO PONTO CLICADO----//
//Clique esquerdo
double PX = 0.0;
double PY = 0.0;
//Clique direito
...
//[EP] ----MÉTODOS RETORNAM OS PONTOS CLICADOS
//Clique esquerdo
...
void glButton::Draw() /* Desenha o botão */ {
    ...
    if (this->visible) {
        ...
        glColor3fv(this->text_color);
        glRasterPos2f(this->edge.left + 0.005, this->edge.top + 0.1); // posiciona onde será escrito no botão
        this->Draw_Label();
    }
